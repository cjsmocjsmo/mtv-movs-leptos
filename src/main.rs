...
use crate::movpages::movspages::{SciFiPage, StalonePage, StarTrekPage, StarWarsPage, StoogesPage, SuperHerosPage};
        ...
        <Router>
            ...
            <main>
                <Routes fallback=|| "Not Found.">
                    ...
                    <Route path=path!("/stooges") view=StoogesPage />
...
fn NavBar() -> impl IntoView {
    view! {
        <nav>
            ...
            <a href="http://10.0.4.58:9093/" class="navItem">"TV Shows"</a>
